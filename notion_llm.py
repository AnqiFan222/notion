...
## 一、资金供应端
### 1. RRP（隔夜逆回购余额），单位为“亿美元”，分析余额变化及其对流动性松紧的信号，注明日期。注意：RRP 的原始数据单位为“十亿美元”，若数值为 6，应换算为“60 亿美元”。
### 2. SRF（常备回购便利余额），单位为“亿美元”，分析银行体系短期资金压力与流动性需求，注明日期。注意：SRF 的原始数据单位为“十亿美元”，若数值为 6，应换算为“60 亿美元”。
### 3. WALCL与TGA（美联储资产负债表与财政部账户），单位为“百万美元”，WALCL（美联储资产负债表总资产）与 TGA（财政部一般账户）合并分析，须在文中明确说明其为周度指标，结合资产负债表扩缩与财政收支对流动性投放或回笼的综合影响，注明日期。
